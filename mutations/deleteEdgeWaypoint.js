...
exports.deleteEdgeWaypoint = void 0;
var addOrGetDrd_1 = require("./addOrGetDrd");
function deleteEdgeWaypoint(_a) {
    var _b, _c;
    var definitions = _a.definitions, drdIndex = _a.drdIndex, edgeIndex = _a.edgeIndex, waypointIndex = _a.waypointIndex;
    ...
    if (waypointIndex > ((_c = (_b = diagramElement["di:waypoint"]) === null || _b === void 0 ? void 0 : _b.length) !== null && _c !== void 0 ? _c : 0) - 1) {
        throw new Error("Can't remove waypoint with index '".concat(waypointIndex, "' from DMNEdge '").concat(diagramElement["@_id"], "' because it doesn't exist."));
    }
    diagramElement["di:waypoint"].splice(waypointIndex, 1);
}
exports.deleteEdgeWaypoint = deleteEdgeWaypoint;
