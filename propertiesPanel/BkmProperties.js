...
function BkmProperties(_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(Form_1.FormGroup, __assign({ label: "Name" }, { children: (0, jsx_runtime_1.jsx)(InlineFeelNameInput_1.InlineFeelNameInput, { enableAutoFocusing: false, isPlain: false, id: bkm["@_id"], name: bkm["@_name"], isReadonly: isReadonly, shouldCommitOnBlur: true, className: "pf-c-form-control", onRenamed: function (newName) {
                    ...
                    }, allUniqueNames: allFeelVariableUniqueNames }) })), (0, jsx_runtime_1.jsx)(Form_1.FormGroup, __assign({ label: "Data type" }, { children: (0, jsx_runtime_1.jsx)(TypeRefSelector_1.TypeRefSelector, { heightRef: dmnEditorRootElementRef, typeRef: (_c = bkm.variable) === null || _c === void 0 ? void 0 : _c["@_typeRef"], onChange: function (newTypeRef) {
                        setState(function (state) {
                            var _a;
                    ...
                    } }) })), (0, jsx_runtime_1.jsx)(Form_1.FormGroup, __assign({ label: "Description" }, { children: (0, jsx_runtime_1.jsx)(TextArea_1.TextArea, { "aria-label": "Description", type: "text", isDisabled: isReadonly, value: (_d = bkm.description) === null || _d === void 0 ? void 0 : _d.__$$text, onChange: function (newDescription) {
                        setState(function (state) {
                            state.dmn.model.definitions.drgElement[index].description = {
                                __$$text: newDescription,
                            };
                        });
                    }, placeholder: "Enter a description...", style: { resize: "vertical", minHeight: "40px" }, rows: 6 }) })), (0, jsx_runtime_1.jsx)(Form_1.FormGroup, __assign({ label: "ID" }, { children: (0, jsx_runtime_1.jsx)(ClipboardCopy_1.ClipboardCopy, __assign({ isReadOnly: true, hoverTip: "Copy", clickTip: "Copied" }, { children: bkm["@_id"] })) })), (0, jsx_runtime_1.jsx)(DocumentationLinksFormGroup_1.DocumentationLinksFormGroup, { isReadonly: isReadonly, values: (_e = bkm.extensionElements) === null || _e === void 0 ? void 0 : _e["kie:attachment"], onChange: function (newExtensionElements) {
                    setState(function (state) {
...
exports.BkmProperties = BkmProperties;
