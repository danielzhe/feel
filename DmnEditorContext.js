...
exports.DmnEditorContextProvider = exports.useDmnEditor = void 0;
var jsx_runtime_1 = require("react/jsx-runtime");
var React = __importStar(require("react"));
var react_1 = require("react");
var DmnEditorContext = React.createContext({});
function useDmnEditor() {
    return (0, react_1.useContext)(DmnEditorContext);
}
exports.useDmnEditor = useDmnEditor;
function DmnEditorContextProvider(props) {
    var dmnModelBeforeEditingRef = (0, react_1.useRef)(props.model);
    var dmnEditorRootElementRef = (0, react_1.useRef)(null);
    ...
    return (0, jsx_runtime_1.jsx)(DmnEditorContext.Provider, __assign({ value: value }, { children: props.children }));
}
exports.DmnEditorContextProvider = DmnEditorContextProvider;
